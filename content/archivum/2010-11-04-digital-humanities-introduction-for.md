...
canonical: "https://szamitogepesnyelveszet.blogspot.com/2010/11/digital-humanities-introduction-for.html"
regi_cimkek:
  - "digital humanities"
  - "guest post"
regi_cimkek_mind:
...
[<span class="lost-media">Hiányzó kép: <a href="http://2.bp.blogspot.com/_SM9YHwWrX6M/TNJJPLy3rnI/AAAAAAAAAWA/XCh5ySk-FEA/s320/addie.jpg" rel="nofollow noopener">addie.jpg</a></span>](http://2.bp.blogspot.com/_SM9YHwWrX6M/TNJJPLy3rnI/AAAAAAAAAWA/XCh5ySk-FEA/s1600/addie.jpg)
...
1. Augmenting existing sources with structured electronic information e.g. creating linked datasets, geo-tagging, and mapping.

1. Analyzing already digitized collections on a large scale e.g. data mining, text mining.

1. Getting tenure.

Number 4 above is where I come in, and I'm not the only traditional computer scientist interested in this stuff. Google [recently announced](http://googleblog.blogspot.com/2010/07/our-commitment-to-digital-humanities.html) 12 awards of $50,000 to proposals for large scale digital humanities analysis centered around Google Books.  
 ...
 The text-analysis sub-sphere I inhabit is getting increasingly populous: other research groups I know are finding thematic trends in [18th century novels](http://chronicle.com/article/The-Humanities-Go-Google/65713/), extracting the names of places, people and things from ancient [Greek and Latin texts](http://www.perseus.tufts.edu/hopper/), and automatically classfying a huge collection of [Scandinavian folklore](http://culturemob.com/blog/google-books-grant-to-fund-research-on-swedish-danish-and-norwegian-texts) into categories based on text content.  
  
 The digital humanities seems to be fueled by a lot of excited people staying in touch with each other through twitter, blogging, and un-conferences. The ["digital humanities"](http://twitter.com/#%21/search/digital%20humanities) search stream on twitter is a good place to join the conversation, and the aggregating blog at [Ditigal Humanities Now](http://digitalhumanitiesnow.org/) is the best way to keep current with what digital humanities bloggers are up to. I've also joined the crowd with my own [blog](http://mininghumanities.com/), where I write about digital humanities from a computer scientist's point of view. The most popular avenue for meeting other researchers with similar interests is [THATCamp](http://thatcamp.org/) the Humanities and technology camp. There's a main event in Virginia every year, and regional, and even international versions almost every month of the year in all kinds of places. The annual [Digital Humanities](http://digitalhumanities.org/) conference is a more serious venue for scholarly work.  
  
 I have found the digital humanities a very welcoming community. And even though I still have no idea what "[hermeneuetics](http://en.wikipedia.org/wiki/Hermeneutics)" is (despite patient explanations from many wise people), it has been no barrier to productive collaboration.
