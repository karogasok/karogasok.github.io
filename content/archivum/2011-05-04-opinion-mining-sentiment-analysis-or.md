...
canonical: "https://szamitogepesnyelveszet.blogspot.com/2011/05/opinion-mining-sentiment-analysis-or.html"
regi_cimkek:
  - "guest post"
regi_cimkek_mind:
  - "guest post"
...
Four types of applications are put forth in ([Pang & Lee, 2008](http://www.cs.cornell.edu/home/llee/opinion-mining-sentiment-analysis-survey.html))’s reference survey :

1. those seeking for customer insight, in movie or product reviews websites or in social networks ;

1. the specific integrations within CRM (Customer Relationship Management) or e-commerce systems ;

1. the strategic foresight and e-reputation applications ;

1. and last but not least, political discourse analysis.
...
Among the numerous problematics related to Opinion Mining and Sentiment Analysis systems adressed in ([Pang & Lee, 2008](http://www.cs.cornell.edu/home/llee/opinion-mining-sentiment-analysis-survey.html))’s, I would pinpoint two of particular interest from a linguistic point of view :
...
1. current processes for adapting Linguistic Resources- such as lexicons or dictionaries – to various domains as an impediment to cost-cutting and reusability.

**Not as easy as it seems**

Indeed, the Social Media industry expresses a growing interest and need towards NLP technologies to overcome issues such as accuracy, robustness and multilinguism. Sentiment Analysis & Opinion Mining became a promising business field a couple of years ago, as a very well documented post by [Doug Henschen](http://www.informationweek.com/authors/1197) for [Information Week](http://www.informationweek.com/news/software/bi/229402598?pgno=1) explains.

But quick recipes are easily found on the web, as shown by a glance on Quora’s « [How does Sentiment Analysis Work ?](http://www.quora.com/Sentiment-Analysis/How-does-sentiment-analysis-work) » thread. Also, a manichean way of viewing things, which implies [an insuperable dichotomy between ''Linguistic Resources'' and ''Machine Learning''](http://www.brandwatch.com/2011/04/how-does-sentiment-analysis-work/), is well-spread in the industry right now. As [Neil Glassman](http://socialtimes.com/author/neilg) writes on [the latest Sentiment Analysis Symposium’s insights](http://whizbangpowwow.com/sentiment-analysis/), he [puts forth](http://whizbangpowwow.com/sentiment-analysis/4-5/) that there is a way
...
- applying statistical and probabilistic calculations to the units that make up comparable textes in a corpus ;
...
[Kurt Williams, Mindshare Technologies CTO](http://www.mshare.net/execteam/williams.htm), accurately wraps it up [ as follows](http://www.mshare.net/blog/sentiment-analysis-symposium-live-updates-new-york-city/) :
...
Please find out more in [ the following presentation displayed at the Sentiment Analysis Symposium](http://www.slideshare.net/MargueriteLeenhardt/interactionlevel-relations-for-opinion-analysis-putting-forth-the-benefits-of-textometry).
...
Special thanks to [Seth Grimes](http://sethgrimes.com/) who chaired the [Sentiment Analysis Symposium](http://sentimentsymposium.com/) and [Neil Glassman](http://socialtimes.com/author/neilg) who nicely [quoted me](http://blog.leenhardt.name/post/2011/03/14/Sentiment-Analysis%2C-Opinion-Mining-neophyte-basics) in his [post](http://whizbangpowwow.com/sentiment-analysis/4-5/).

**About the author**

Margueritte Leenhardt is a PhD student at the Université Paris 3 (Sorbonne Nouvelle) and an R&D Consultant - Project manager at [Le Sémiopôle](http://www.le-semiopole.fr/). She's got an excellent professional [blog](http://blog.leenhardt.name/), and you can find her on twitter as [@MyLinguistics](http://twitter.com/#%21/mylinguistics).
