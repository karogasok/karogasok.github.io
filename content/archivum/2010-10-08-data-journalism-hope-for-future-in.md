...
canonical: "https://szamitogepesnyelveszet.blogspot.com/2010/10/data-journalism-hope-for-future-in.html"
regi_cimkek:
  - "interview"
regi_cimkek_mind:
  - "data journalism"
...
**We interviewed** [**Mirko Lorenz**](http://bit.ly/dv5LS6) **who is an information architect, journalist & trainer. He studied History and Economics at the University of Cologne, then worked for various new media companies. Currently he is working with[ ](http://bit.ly/9DI6OS)**[**Deutsche Welle**](http://bit.ly/9DI6OS) **and organised the** [**European Journalism Centre**](http://bit.ly/cFKdaK)**'s[ ](http://bit.ly/d3s2T0)**[**conference on data journalism**](http://bit.ly/d3s2T0) **among other things. You can find him on twitter as** [**@mirkolorenz**](http://bit.ly/cfcggD).

**Számítógépes nyelvészet: For most of us (computational linguists and alike folks), data journalism is known from Django co-creator** [**Adrian Holovaty**](http://bit.ly/cvtOr1)**'s writings, but we're just scratching the surface of the concept. It has to do something with data, and it is related to journalism, but what is data journalism exactly?**

**Mirko Lorenz:** Your are right that Holovaty pointed out the value of data and delivered a wake-up call. But if you look at when "[A fundamental way how newspapers have to change](http://bit.ly/9ScOn8)" was written - it's four years ago. How many media organisations have really acted by now? Not many.
...
**The most notable (and known) examples of data journalism are the** [**Guardian**](http://bit.ly/damPpK) **and** [**NY Times**](http://bit.ly/9NWMx9) **APIs, but these are just the stepping stones towards build a mash-up on the data. Is there any difference between using an open data (gathered from governmental agencies or other places) and data journalism?**
...
**Journalism is said to be the** **"[Fourth Estate](http://bit.ly/d6sZSa)"** **but** [**gov 2.0**](http://bit.ly/aIXK2g) **and other movements (**[**open data**](http://bit.ly/d2HdAx)**,** [**open government**](http://bit.ly/bqlwE6)**, etc) are changing the picture since all of them is trying to give back the control to the citizens by providing them information directly and they don't need newspapers to explain and gather the data. How can journalism, esp. data journalism, reflect to this change?**
...
I am in line with others like [Paul Bradshaw](http://bit.ly/bTDahf) or [Aron Pilhofer](http://bit.ly/bWoon9) here: Always, always, always remember that you are a journalist in the first place and that finding a story is your main assignment. Related to data the first question is not what tool I need, but what the question is. See how [Hans Rosling](http://bit.ly/bM9DU3) first had a question and only then developed an innovation like [Gapminder](http://bit.ly/bIaQFl).
...
To get a good introduction what is state of the art, I would recommend to look at three sources at the moment: First, watch the [talk by David McCandless](http://bit.ly/bvq70D) that is available via Ted.com.

Secondly, watch the documentation on "[Journalism in the Age of Data](http://bit.ly/duQweP)", produced by Geoff McGhee .

And then, you might be interested in our documentation of the Amsterdam data-driven journalism conference, a PDF we named "[Data-driven journalism: What is there to learn](http://bit.ly/cN6HIu)". The download is free.

**Link:**

**Mirko Lorenz Homepage ([http://www.mirkolorenz.com](http://bit.ly/dv5LS6))**
